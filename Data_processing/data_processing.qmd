...
library(wCorr)
theme_set(theme_bw())
files=list.files("Data_2023/Count_table/FASTP","counts_ampliconseq2023_f2_.-..tsv", full.names = T)
...
```{r}
QC=readODS::read_ods("Data_2023/QC_summary.ods", .name_repair = "universal")%>%filter(!is.na(id))
...
parallel -j12 source filename.sh :::: tmp.txt

```

3- Trim primers with *cutadapt*. Discard those reads lacking the primer.
...
#corregir los tar
trimmed1="Trimming/FASTP/trimmed_fastq_$1_R1.fastq"
trimmed2="Trimming/FASTP/trimmed_fastq_$1_R2.fastq"
sam_file="Alignment/FASTP/alignment_$1.sam"
sam_summary_file="Alignment/FASTP/alignment_summary_$1.sam"
...
bam_file="Alignment/FASTP/alignment_$1.bam"
sorted_file="Alignment/FASTP/alignment_sorted_$1.bam"
...
output="Count_table/counts_ampliconseq2023_f2_$1.tsv"	
