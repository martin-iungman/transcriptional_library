...
p+stat_compare_means()+theme_pubclean()+labs(fill="Cpg island", x=NULL, y="Transcriptional mean activity")+theme(axis.text.x = element_blank(), axis.ticks.x = element_blank())
...
p+stat_compare_means()+theme_pubclean()+labs(fill="CpG isalnd", x=NULL, y="Transcriptional mean activity")+theme(axis.text.x = element_blank(), axis.ticks.x = element_blank())
